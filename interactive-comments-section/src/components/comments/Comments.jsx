...
import { increment, decrement, incrementReplie, decrementReplie } from "../../features/comment"
import "./Comments.css"
...
export default function Comments() {
  ...
  const commentReplies = useSelector(state => state.replies)
  const currentUser = useSelector(state => state.currentUser)

  console.log(commentList.replies);
      ...
      {commentList.comment.map(com => (
        <div key={com.id} className="container-comment-replie">
          ...
          <div className="container-replies">
            ...
            {commentList.replies.filter(reply => reply.replyingTo === com.username).map(replie => (
